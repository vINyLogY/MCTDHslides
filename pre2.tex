...
\begin{document}
    ...
    \begin{frame}{Multi-Layer}
        More nodes, but smaller ranks and smaller range of indices.
    ...
    \begin{frame}{Multi-Layer}
        ...
        \begin{center}
            ...
            \end{tikzpicture}
        \end{center}
        For a complete binary tree, the space for saving a wavefunction is $\BigO{dn^3}$ floats, if $n_{\ell} = \BigO{n}$ for all $\ell$.
    \end{frame}
    ...
    \begin{frame}{Normalization}
        ...
        \begin{center}
            ...
            \end{tikzpicture}
        \end{center}
        where $\vb{g}$ is a hermitian matrix. For simplicity, choose $\vb{g} = \vb{0}$.
    \end{frame}
    ...
    \begin{frame}{Equations of Motion (Cont'd)}
        ...
        \begin{center}
            ...
            $
        \end{center}
        Time complexity: if $\rank{} \leqslant p$ for all nodes, then a step of multiplication is of $\BigO{t p d n^{p+1}}$;

        Space complexity: $\BigO{t p d n^2 + d n^p}$.
    \end{frame}
